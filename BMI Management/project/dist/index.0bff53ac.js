...
})({"g2IK1":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "2f4415520bff53ac";
...
},{}],"jKD0T":[function(require,module,exports) {
...
var _localStorageHandlerJs = require("./localStorageHandler.js");
var _localStorageHandlerJsDefault = parcelHelpers.interopDefault(_localStorageHandlerJs);
var _dataHandlerJs = require("./dataHandler.js");
var _dataHandlerJsDefault = parcelHelpers.interopDefault(_dataHandlerJs);
...
$("#mainForm").addEventListener("submit", (e)=>{
    ...
    if (_uiHandlerJsDefault.default.isValidated()) {
        ...
        _localStorageHandlerJsDefault.default.addPersonToLocalSt(newUser);
        _uiHandlerJsDefault.default.addPersonToTable(newUser);
        _uiHandlerJsDefault.default.clearInput();
        _uiHandlerJsDefault.default.scrollToTop();
        _uiHandlerJsDefault.default.showMsg("User Added", "alert-success");
    } else {
        _uiHandlerJsDefault.default.scrollToTop();
        _uiHandlerJsDefault.default.showMsg("Please enter all field!", "alert-danger");
    }
});
//Remove person
$("#tableOutput").addEventListener("click", (e)=>{
    if (e.target.classList.contains("remove")) {
        if (confirm(`Do you want to delete user ${e.target.parentElement.parentElement.children[1].innerText}?`)) {
            const tr = e.target.parentElement.parentElement;
            const personId = e.target.parentElement.parentElement.firstElementChild.innerText;
            tr.remove();
            _localStorageHandlerJsDefault.default.removePerson(personId);
        }
    }
});
//Handle Edit button
// Show change form
$("#tableOutput").addEventListener("click", (e)=>{
    if (e.target.classList.contains("edit")) _uiHandlerJsDefault.default.showFormEdit(e);
});
...
$("#changeForm").addEventListener("submit", (e)=>{
    ...
    //Edit in store
    _localStorageHandlerJsDefault.default.editPersonToLocal(changeName, changeAge, changeEmail, changeGender, changeHeight, changeWeight, changeAddress, userId);
    _uiHandlerJsDefault.default.showMsg("Edit successful!", "alert-success");
    _uiHandlerJsDefault.default.clearTable();
    _uiHandlerJsDefault.default.showPersons();
    e.preventDefault();
});
//Reload button event
$("#reloadBtn").addEventListener("click", ()=>{
    _uiHandlerJsDefault.default.reloadBtn();
});
//Event generate 10 data and add data to list and local storage:
$("#generateBtn").addEventListener("click", (e)=>{
    e.preventDefault();
    if (confirm("Are you sure to generate 10 random data?")) {
        for(let i = 0; i < 10; i++)_localStorageHandlerJsDefault.default.addPersonToLocalSt(_dataHandlerJsDefault.default.generateData());
        _uiHandlerJsDefault.default.clearTable();
        _uiHandlerJsDefault.default.showPersons();
        _uiHandlerJsDefault.default.scrollToTop();
        _uiHandlerJsDefault.default.showMsg("Random users generated!", "alert-success");
    }
});
...
$("#emptyBtn").addEventListener("click", (e)=>{
    ...
    if (confirm("Are you sure to clear all data?")) {
        ...
        _uiHandlerJsDefault.default.clearTable();
        _uiHandlerJsDefault.default.scrollToTop();
        _uiHandlerJsDefault.default.showMsg("All data cleared!", "alert-success");
    }
});
//Event search Data:
$("#searchBtn").addEventListener("click", (e)=>{
    ...
    if (keywords.length !== 0) _dataHandlerJsDefault.default.filterData(keywords, searchType);
});

},{"./Model/Persons.js":"evHc5","./uiHandler.js":"coja9","./localStorageHandler.js":"h9ycJ","./dataHandler.js":"bkQXA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"evHc5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"short-uuid":"jN6NV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jN6NV":[function(require,module,exports) {
/**
...
},{}],"coja9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _personsJs = require("./Model/Persons.js");
var _personsJsDefault = parcelHelpers.interopDefault(_personsJs);
...
uiHandler.showPersons = function() {
    const personsArr = _localStorageHandlerJsDefault.default.getLocalStArr();
...
uiHandler.showFormEdit = function(e) {
    ...
    let persons = _localStorageHandlerJsDefault.default.getLocalStArr();
...
},{"./Model/Persons.js":"evHc5","./localStorageHandler.js":"h9ycJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h9ycJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _personsJs = require("./Model/Persons.js");
var _personsJsDefault = parcelHelpers.interopDefault(_personsJs);
...
localSt.getLocalStArr = function() {
    let arr;
    if (!localStorage.getItem("persons")) arr = [];
    else arr = JSON.parse(localStorage.getItem("persons"));
    return arr;
};
...
localSt.editPersonToLocal = function(changeName, changeAge, changeEmail, changeGender, changeHeight, changeWeight, changeAddress, userId) {
    let changePerson = new _personsJsDefault.default(changeName, changeAge, changeGender, changeEmail, parseInt(changeHeight) / 100, changeWeight, changeAddress, userId);
    let persons = localSt.getLocalStArr();
    persons.forEach((person)=>{
        if (person.id === userId) person.name = changePerson.name, person.age = changePerson.age, person.email = changePerson.email, person.gender = changePerson.gender, person.height = changePerson.height, person.weight = changePerson.weight, person.address = changePerson.address, person.bmi = changePerson.bmi, person.healthStatus = changePerson.healthStatus;
    });
    localStorage.setItem("persons", JSON.stringify(persons));
};
exports.default = localSt;

},{"./Model/Persons.js":"evHc5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bkQXA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _uiHandler = require("./uiHandler");
var _uiHandlerDefault = parcelHelpers.interopDefault(_uiHandler);
var _personsJs = require("./Model/Persons.js");
var _personsJsDefault = parcelHelpers.interopDefault(_personsJs);
var _localStorageHandler = require("./localStorageHandler");
var _localStorageHandlerDefault = parcelHelpers.interopDefault(_localStorageHandler);
const log = console.log;
const $ = document.querySelector.bind(document);
class DataHandler {
    static generateData() {
        ...
        let person = new _personsJsDefault.default(randomName, randomAge, randomGender, randomEmail, randomHeight, randomWeight, randomAddress);
        return person;
    }
    //Data search handler
    static filterData(keywords, searchType) {
        let personsArr = _localStorageHandlerDefault.default.getLocalStArr();
        let matches;
        ...
        _uiHandlerDefault.default.clearTable();
        matches.forEach((match)=>_uiHandlerDefault.default.addPersonToTable(match)
        );
    }
}
exports.default = DataHandler;

},{"./uiHandler":"coja9","./Model/Persons.js":"evHc5","./localStorageHandler":"h9ycJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["g2IK1","jKD0T"], "jKD0T", "parcelRequire3b87")

//# sourceMappingURL=index.0bff53ac.js.map
